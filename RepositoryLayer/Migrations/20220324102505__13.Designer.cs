...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.DatabaseModels.Authentication.UserStatus", b =>
                {
                    ...
                    b.Property<string>("UserStatusNameAbbr")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Core.Application", b =>
                {
                    ...
                    b.Property<long>("ApplicationPhaseId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Core.HPAHistory", b =>
                {
                    b.Property<long>("HPAHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Core.VehicleRegistrationHistory", b =>
                {
                    ...
                    b.Property<string>("PreviousRegNo")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Setup.ApplicationPhase", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ApplicationPhase", "Setup");
                });
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Setup.ApplicationType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ApplicationType", "Setup");
                });
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempAddress", b =>
                {
                    b.Property<long>("AddressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempAddress", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempApplication", b =>
                {
                    b.Property<long>("ApplicationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempApplication", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempBusiness", b =>
                {
                    b.Property<long>("BusinessId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempBusiness", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempHPA", b =>
                {
                    ...
                    b.Property<string>("HPALetterNo")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<long>("HPATerminatedByUserId")
                        .HasColumnType("bigint");

                    b.Property<DateTime>("HPATerminationDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("HPATerms")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("HPATerminatedByUserId");

                    b.HasIndex("SponserBusinessId");

                    b.HasIndex("VehicleId");

                    b.ToTable("TempHPA", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempKeeper", b =>
                {
                    b.Property<long>("KeeperId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("KeeperBusinessId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("KeeperBusinessId");

                    b.HasIndex("KeeperPersonId");

                    b.HasIndex("VehicleId");

                    b.ToTable("TempKeeper", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempOwner", b =>
                {
                    b.Property<long>("OwnerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ExistingOwnerId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TempOwner", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempPerson", b =>
                {
                    b.Property<long>("PersonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempPerson", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempPhoneNumber", b =>
                {
                    b.Property<long>("PhoneNumberId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempPhoneNumber", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempRemarks", b =>
                {
                    b.Property<long>("RemarksId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempRemarks", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempVehicle", b =>
                {
                    b.Property<long>("VehicleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempVehicle", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempVehicleAuctionInfo", b =>
                {
                    b.Property<long>("VehicleAuctionInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempVehicleAuctionInfo", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempVehicleDocument", b =>
                {
                    b.Property<long>("VehicleDocumentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempVehicleDocument", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempVehicleImportInfo", b =>
                {
                    b.Property<long>("VehicleImportInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempVehicleImportInfo", "Core");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempVehiclePurchaseInfo", b =>
                {
                    b.Property<long>("VehiclePurchaseInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("TempVehiclePurchaseInfo", "Core");
                });
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Core.Application", b =>
                {
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Setup.ApplicationPhase", "ApplicationPhase")
                        .WithMany()
                    ...
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Setup.ApplicationType", "ApplicationType")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempAddress", b =>
                {
                    ...
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Temp.TempApplication", "Application")
                        .WithMany()
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Temp.TempBusiness", "Business")
                        .WithMany()
                        .HasForeignKey("BusinessId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Temp.TempPerson", "Person")
                        .WithMany()
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempBusiness", b =>
                {
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Temp.TempApplication", "TempApplication")
                        .WithMany()
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempHPA", b =>
                {
                    ...
                    b.HasOne("Models.DatabaseModels.Authentication.User", "HPATerminatedBy")
                        .WithMany()
                        .HasForeignKey("HPATerminatedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Temp.TempVehicle", "Vehicle")
                        .WithMany()
                        .HasForeignKey("VehicleId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempKeeper", b =>
                {
                    ...
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Temp.TempBusiness", "Business")
                        .WithMany()
                        .HasForeignKey("KeeperBusinessId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Temp.TempRemarks", b =>
                {
                    ...
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Temp.TempOwner", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.NoAction);
