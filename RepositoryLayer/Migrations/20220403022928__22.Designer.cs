...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Core.AssessmentState", b =>
                {
                    b.Property<long>("AssessmentStateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("AssessmentState", "Core");
                });
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Core.Dues", b =>
                {
                    ...
                    b.Property<long>("DuesStatusId")
                        .HasColumnType("bigint");

                    b.Property<long>("DuesTypeId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AssessmentStateId");

                    b.HasIndex("ChallanId");

                    b.HasIndex("CreatedBy");

                    b.HasIndex("DuesStatusId");
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Core.VehicleTax", b =>
                {
                    b.Property<long>("VehicleTaxId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Setup.DuesStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("DuesStatus", "Setup");
                });

            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Setup.DuesType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Models.DatabaseModels.VehicleRegistration.Core.Dues", b =>
                {
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Core.AssessmentState", "AssessmentState")
                        .WithMany()
                        .HasForeignKey("AssessmentStateId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Setup.DuesStatus", "DuesStatus")
                        .WithMany()
                        .HasForeignKey("DuesStatusId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Models.DatabaseModels.VehicleRegistration.Setup.DuesType", "DuesType")
                        .WithMany()
                    ...
                    b.Navigation("AssessmentState");

                    b.Navigation("Challan");

                    b.Navigation("DuesStatus");
