...
namespace APIGateway.Controllers.SetupControllers
{
    ...
    public class OwnerStatusController : ControllerBase
    {
        private readonly Setup.ISetupservice<OwnerStatus> _service;
        private readonly ILog _logger;


        public OwnerStatusController(Setup.ISetupservice<OwnerStatus> service, ILog logger)
        {
            _service = service;
            _logger = logger;
        }
