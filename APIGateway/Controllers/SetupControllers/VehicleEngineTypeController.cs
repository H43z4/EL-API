...
namespace APIGateway.Controllers.SetupControllers
{
    ...
    {
        private readonly Setup.ISetupservice<VehicleEngineType> _service;
        private readonly ILog _logger;


        public VehicleEngineTypeController(Setup.ISetupservice<VehicleEngineType> service, ILog logger)
        {
            _service = service;
            _logger = logger;
        }
