...
namespace APIGateway.Controllers.SetupControllers
{
    ...
    {
        private readonly Setup.ISetupservice<VehicleClassification> _service;
        private readonly ILog _logger;


        public VehicleClassificationController(Setup.ISetupservice<VehicleClassification> service, ILog logger)
        {
            _service = service;
            _logger = logger;
        }
