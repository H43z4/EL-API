...
namespace APIGateway.Controllers.SetupControllers
{
    ...
    public class VehiclePurchaseTypeController : ControllerBase
    {
        private readonly Setup.ISetupservice<VehiclePurchaseType> _service;
        private readonly ILog _logger;


        public VehiclePurchaseTypeController(Setup.ISetupservice<VehiclePurchaseType> service, ILog logger)
        {
            _service = service;
            _logger = logger;
        }
