...
namespace APIGateway.Controllers.SetupControllers
{
    ...
    public class VehicleBodyConventionController : ControllerBase
    {
        private readonly Setup.ISetupservice<VehicleBodyConvention> _service;
        private readonly ILog _logger;


        public VehicleBodyConventionController(Setup.ISetupservice<VehicleBodyConvention> service, ILog logger)
        {
            _service = service;
            _logger = logger;
        }
