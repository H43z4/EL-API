...
namespace APIGateway.Controllers.SetupControllers
{
    ...
    {
        private readonly Setup.ISetupservice<OrganizationCategory> _service;
        private readonly ILog _logger;


        public OrganizationCategoryController(Setup.ISetupservice<OrganizationCategory> service, ILog logger)
        {
            _service = service;
            _logger = logger;
        }
