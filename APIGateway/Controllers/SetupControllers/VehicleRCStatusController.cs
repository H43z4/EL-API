...
namespace APIGateway.Controllers.SetupControllers
{
    ...
    public class VehicleRCStatusController : ControllerBase
    {
        private readonly Setup.ISetupservice<VehicleRCStatus> _service;
        private readonly ILog _logger;


        public VehicleRCStatusController(Setup.ISetupservice<VehicleRCStatus> service, ILog logger)
        {
            _service = service;
            _logger = logger;
        }
