...
namespace APIGateway.Controllers.SetupControllers
{
    ...
    public class VehicleSchemeController : ControllerBase
    {
        private readonly Setup.ISetupservice<VehicleScheme> _service;
        private readonly ILog _logger;


        public VehicleSchemeController(Setup.ISetupservice<VehicleScheme> service, ILog logger)
        {
            _service = service;
            _logger = logger;
        }
